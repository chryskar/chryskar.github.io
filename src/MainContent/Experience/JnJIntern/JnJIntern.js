            ...
            <div className="container d-flex flex-column">
                ...
                <span className="text-body m-3">
                    ...
                    <ul className="m-3">
                        ...
                        <li className="mb-3"><span className="fw-medium">Theoretical Skill Enhancement:</span> Studied both the modeling and the control of a redudant cable-driven robotic manipulator, including forward and inverse kinematics, differential kinematics, and transitioning between the joint and configuration space through Jacobian matrices. Delved into admittance control, which was an integral part of this proejct. Actively attended group studies on state estimation, focusing on Bayes, Kalman and Extended Kalman filters.</li>
                    </ul>
                </span>
