    ...
    return (
        <div>
            <div className="container d-flex flex-column px-5">
                ...
                <h2 className="fw-bold my-3">Foot VErtical & Sagittal Position Algorithm (F-VESPA)</h2>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', flexWrap: 'wrap' }}>
                    <img src={analysis_fvespa} alt="Logo 2" className="section-logo m-2" style={{ maxHeight: '300px', width: 'auto', maxWidth: '100%' }} />
                    <img src={pseudo_code} alt="Logo 2" className="section-logo m-2" style={{ maxHeight: '300px', width: 'auto', maxWidth: '100%' }} />
                </div>
                ...
                <h3 className="fw-medium my-3">Detailed Information and Versions:</h3>
