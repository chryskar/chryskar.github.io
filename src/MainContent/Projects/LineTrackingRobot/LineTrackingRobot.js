    ...
    return (
        <div>
            <div className="container d-flex flex-column px-5 px-md-0">
                ...
                <h2 className="fw-bold my-3">Line Tracking Robot (MEEG 667: Digital Control)</h2>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', flexWrap: 'wrap' }}>
                    <img src={track} alt="Logo 2" className="section-logo m-2" style={{ maxHeight: '300px', width: 'auto', maxWidth: '100%' }} />
                    <img src={side_view_robot} alt="Logo 2" className="section-logo m-2" style={{ maxHeight: '300px', width: 'auto', maxWidth: '100%' }} />
