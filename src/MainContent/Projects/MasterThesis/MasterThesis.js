    ...
    return (
        <div>
            <div className="container d-flex flex-column px-5">
                ...
                <h2 className="fw-bold my-3">Exploiting the SoC FPGA Capabilities in the Control Architecture of a Quadruped Robot</h2>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', flexWrap: 'wrap' }}>
                    <img src={boards} alt="Logo 2" className="section-logo m-2" style={{ maxHeight: '300px', width: 'auto', maxWidth: '100%' }} />
                    <img src={robot_boards} alt="Logo 2" className="section-logo m-2" style={{ maxHeight: '300px', width: 'auto', maxWidth: '100%' }} />
                </div>
                ...
                <h3 className="fw-medium my-3">Publication and Recognition:</h3>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
                    <iframe className="my-3" src="https://drive.google.com/file/d/1xEWogmWNpEuPR-bF9t8tGTfFUzNKVGzq/preview" title="YouTube video replayer" width="640" height="360" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                </div>
