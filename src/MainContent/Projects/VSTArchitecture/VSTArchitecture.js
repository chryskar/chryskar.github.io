    ...
    return (
        <div>
            <div className="container d-flex flex-column">
                ...
                <h2 className="fw-bold m-3">Software Architecture for Variable Stiffness Treadmill 1</h2>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
                    <img src={terminals} alt="Logo 2" className="section-logo m-2" style={{ height: '300px', width: 'auto' }} />
