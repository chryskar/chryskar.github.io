...
import Ranking from "./img/beli_logo.jpg"
        ...
        <div>
            <div className="d-flex flex-column align-items-center justify-content-center">
                ...
                <div className="container d-flex flex-wrap justify-content-center">
                    ...
                    <Link to="ranking" className="d-flex flex-column align-items-center m-5 clickable" style={{ color: 'black' }}>
                        <img src={Ranking} alt="Beli img" className="section-logo m-2" style={{ width: 'auto', maxHeight: '250px', maxWidth: '100%' }} />
                        <h4 className="fw-bold m-2">Ranking Food</h4>
                    </Link>

                    <Link to="cooking" className="d-flex flex-column align-items-center m-5 clickable" style={{ color: 'black' }}>
                        <img src={Cooking} alt="Cooking" className="section-logo m-2" style={{ width: 'auto', maxHeight: '250px', maxWidth: '100%' }} />
                        <h4 className="fw-bold m-2">Cooking</h4>
                    </Link>
